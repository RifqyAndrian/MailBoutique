...
<div class="container">
    <div class="card w-50 m-auto">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="<?php echo e(url('/profile/edit/save')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <a class="btn btn-danger mt-3 w-100" href="<?php echo e(url()->previous()); ?>">Back</a>
                    </form>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', ['menus' => App\Utils\HeaderUtil::getMenu()], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Fastwork\Jack\laravel\maiboutique\resources\views/edit_profile.blade.php ENDPATH**/ ?>