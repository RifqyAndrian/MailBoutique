...
<div class="container">
    <div class="card w-50 m-auto">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="<?php echo e(url('/product/add')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="file" name="image" class="form-control">
...
unset($__errorArgs, $__bag); ?>" name="stock" value="<?php echo e(old('stock')); ?>" required autocomplete="stock">
...
<?php echo $__env->make('layouts.app', ['menus' => App\Utils\HeaderUtil::getMenu()], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Fastwork\Jack\laravel\maiboutique\resources\views/add_item.blade.php ENDPATH**/ ?>